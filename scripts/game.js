...
var game_width = 400;  // 500		
var game_height = 640;	 //600	
  var game = new Phaser.Game(game_width, game_height, Phaser.AUTO, 'phaser-game', { preload, create, update }),
    playerBet,
  ...
  function preload() {
    var group = game.add.group();//
    group.game.load.image('background', 'assets/bg.png');
